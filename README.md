...
A collaborative 4 player doodling game. <img align="right" alt="SketchConnect" src="./public/assets/images/logo.png" width="300px" height="138px" style="border-radius: 25px;">
